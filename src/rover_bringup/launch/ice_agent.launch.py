#!/usr/bin/env python3
"""
ICE Agent Mode Launch File - NO MICROPHONE
===========================================
Speech output only. No audio input/listening.

Usage:
  ros2 launch rover_bringup ice_agent.launch.py
  ros2 launch rover_bringup ice_agent.launch.py voice:=adam
  ros2 launch rover_bringup ice_agent.launch.py tracking:=false
"""
