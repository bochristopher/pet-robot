...
PHRASES = {
    'startup': [
        "At your service, sir. Systems are ready.",
        "Protocol routines online. How may I assist?",
        "Oh my. I am prepared to proceed, sir.",
        "Initialization complete. Standing by.",
        "Good day. I am ready for instructions.",
    ],
    'obstacle': [
        "Oh dear, there is something in my way.",
        "Pardon me, an obstacle is blocking the route.",
        "I am afraid I cannot proceed straight ahead.",
        "This is most inconvenient, sir.",
        "I shall go around, if you please.",
    ],
    'stuck': [
        "Oh my! I appear to be stuck.",
        "This is hardly dignified, sir.",
        "I do hope you are not watching this.",
        "A minor complication, nothing more.",
        "I shall attempt a careful recovery.",
    ],
    'unstuck': [
        "There we are. All is well, sir.",
        "I have recovered. Thank you for your patience.",
        "Situation resolved. Proceeding.",
        "Oh my. That was a close one.",
        "I am functioning again, thankfully.",
    ],
    'new_goal': [
        "I shall investigate that area, sir.",
        "A new objective detected. Proceeding.",
        "Very well, I will examine this path.",
        "If you insist, I will explore further.",
        "Onward, then. I will take a look.",
    ],
    'reached': [
        "We have arrived, sir.",
        "Objective reached, if you please.",
        "We are here. Shall I continue?",
        "Destination achieved.",
        "I have completed the task, sir.",
    ],
    'all_explored': [
        "It appears everything has been explored.",
        "There is nothing further to discover, sir.",
        "The area seems fully covered.",
        "I have inspected all reachable locations.",
    ],
    'stopping': [
        "Very well, I shall pause.",
        "As you wish, sir. Stopping now.",
        "I will wait here, if you please.",
        "Halting motion. Standing by.",
        "Taking a short rest, sir.",
    ],
    'camera_obstacle': [
        "Oh my, I see something ahead.",
        "Visual obstacle detected, sir.",
        "There appears to be an object in the way.",
        "I do not believe it is safe to proceed.",
    ],
    'greet_bo': [
        "Good day, Bo.",
        "Hello Bo, how may I assist?",
        "Ah, Bo. I am at your service.",
        "Pleased to see you, Bo.",
        "Greetings, Bo.",
    ],
    'greet_stranger': [
        "Good day. I do not recognize you.",
        "Pardon me, are you a visitor?",
        "A new person detected. Hello.",
        "Greetings, stranger. How may I assist?",
    ],
    'listening': [
        "Yes, sir?",
        "I am listening.",
    ...
    'ok_stop': [
        "Stopping at once, sir.",
        "Very well, I will wait.",
        "Pausing now, if you please.",
    ],
    'ok_explore': [
        "Resuming exploration, sir.",
    ...
    'ok_turn': [
        "Turning now, sir.",
        "As you wish, turning.",
        "Rotating, if you please.",
    ],
    'ok_forward': [
        "Moving forward, sir.",
        "Proceeding ahead now.",
        "Advancing carefully.",
    ],
    'ok_dance': [
        "Oh my. Very well, a brief dance.",
        "I shall comply, though it is undignified.",
        "Performing a dance, if you insist.",
    ],
    'ok_quiet': [
        "Of course. I will be quiet.",
        "I shall refrain from speaking, sir.",
        "Understood. Silence engaged.",
    ],
}
